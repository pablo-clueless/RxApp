...
export const EndDate = () => {
  return (
    <View style={{ paddingHorizontal: SIZES.font, paddingVertical: SIZES.base, 
    backgroundColor: COLORS.white, justifyContent: 'center', alignItems: 'center', ...SHADOWS.light,
...
export const ImageCmp = ({ imgUrl, index }) => {
  return (
    ...
    style={{ width: 42, height: 42, marginLeft: index === 0 ? 0 : -SIZES.font }} />
  )
}
...
export const NFTTitle = ({ title, subtitle, titleSize, subtitleSize }) => {
  return (
    ...
    <Text style={{ fontFamily: FONTS.regular, fontSize: subtitleSize, color: COLORS.primary, textTransform: 'capitalize'}}>
        {subtitle}
    </Text>
    </View>
  )
...
export const SubInfo = () => {
  return (
    ...
    marginTop: SIZES.extraLarge, flexDirection: 'row', justifyContent: 'space-between' }}>
      <People />
      <EndDate />
    </View>
  )
